...
object SendTestFps {
  def main(args: Array[String]): Unit = {
    ...
    val eventHubName: String = "fpstesting"
    val sasKeyName:String ="RootManageSharedAccessKey"
    val sasKey :String="ivthHAaz0UJQYgEl1I4JMn7hXzokbEUQm8vH97umiN4="
...
//    val message ="""{"AdrReqId":"AE95420190212M0000000000000000009","Sts":"ACCT","RjctRsn":"","ProxyId":"+852-90737855","ProxyIdTp":"MOBN","PurpCd":"PAYM","DeviceId":"0e83ff56a12a9cf0c7290cbb08ab6752181fb54b","IpAddress":"127.0.0.1","Rslt":{"CusNm":[{"Lang":"EN","FullNm":"Shin Chan","DispNm":"Shin"},{"Lang":"ZH","FullNm":"陳 真","DispNm":"真"}],"CusId":"CusId_1212","MmbId":"003","CusTp":"PERS"},"SupOp":{"Cd":"RTOP"},"MemberId":"D031000217"}"""

//    val message ="""{"AdrReqId":"AE95420190212M0000000000000000012","Sts":"ACCT","RjctRsn":"","ProxyId":"+852-90737855","ProxyIdTp":"MOBN","PurpCd":"PAYM","DeviceId":"0e83ff56a12a9cf0c7290cbb08ab6752181fb54b","IpAddress":"127.0.0.1","TestComplex":{"complex":"xxxxxx"},"Rslt":{"CusNm":[{"Lang":"EN","FullNm":"Shin Chan","DispNm":"Shin"},{"Lang":"ZH","FullNm":"陳 真","DispNm":"真"}],"CusId":"CusId_1212","MmbId":"003","CusTp":"PERS"},"SupOp":{"Cd":"RTOP"},"MemberId":"D031000217"}"""
//    val message ="""{"AdrReqId":"AE95420190212M0000000000000000006","Sts":"RJCT","RjctRsn":"ADRS0009","ProxyId":"abcd.def3@example.mail.net","ProxyIdTp":"EMAL","PurpCd":"PAYM","Rslt":{"CusNm":[{"Lang":"EN","FullNm":"Shin Chan","DispNm":"Shin"}],"CusId":"CusId_1212","MmbId":"003","CusTp":"PERS"},"SupOp":{"Cd":"RTOP"},"MemberId":"D031000217"}"""

    var i=0
        while (true) {
          val message =s"""{"AdrReqId":"${i}","Sts":"ACCT","RjctRsn":"","ProxyId":"+852-90737855","ProxyIdTp":"MOBN","PurpCd":"PAYM","DeviceId":"0e83ff56a12a9cf0c7290cbb08ab6752181fb54b","IpAddress":"127.0.0.1","TestComplex":{"complex":"xxxxxx"},"Rslt":{"CusNm":[{"Lang":"EN","FullNm":"Shin Chan","DispNm":"Shin"},{"Lang":"ZH","FullNm":"陳 真","DispNm":"真"}],"CusId":"CusId_1212","MmbId":"003","CusTp":"PERS"},"SupOp":{"Cd":"RTOP"},"MemberId":"D031000217"}"""
          sendEvent(message)
          i=i+1
          Thread.sleep(10000)
        }
